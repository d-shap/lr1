...
public final class EbnfChoiceTest {
    ...
    public void serializationTest() {
        ...
        EbnfNode node3 = new EbnfSpecial(position, "c");
        List<EbnfNode> nodes = Arrays.asList(node1, node2, node3);
        EbnfChoice choice = new EbnfChoice(position, nodes);
        EbnfChoice deserialized = SerializationHelper.serializeAndDeserialize(choice);
        ...
        Assertions.assertThat(deserialized).hasToString("Choice(Terminal(a), Reference(b), Special(c))");
    }
